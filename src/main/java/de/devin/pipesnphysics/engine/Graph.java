...
public final class Graph {
    ...
    /** Edges incident to the given node, in no particular order. Do not modify. */
    public List<Edge> edgesOf(int nodeIndex) { return incident.get(nodeIndex); }

    /** All HANDLER nodes (tanks, basins, drains, etc.). Do not modify. */
    public List<Node> handlers() { return handlers; }

    /** All PUMP nodes. Do not modify. */
